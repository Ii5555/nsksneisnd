...
bot = telebot.TeleBot("5055896944:AAE0ZPL8YJcCWW-P2fiABoWJrHD6KCdH1os")
a = list()
...
def st(message):
    ...
    btn4 = types.InlineKeyboardButton(text="- المبرمج .",url="t.me/lvf2i")
    key.add(btn2)
    key.add(btn3)
    key.add(btn4)

    bot.reply_to(message,f"-اهلا بك في بوت فحص يوزرات Tiki\n- يمكنك الاختيار طريقة الفحص من الاسفل المطور @Hamouddi.",reply_markup=key)
